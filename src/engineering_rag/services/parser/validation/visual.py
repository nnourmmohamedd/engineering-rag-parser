...
from engineering_rag.services.parser.models import CheckResult, PageCoverage, Severity, SourceManifest
from engineering_rag.services.parser.preflight import render_page_png
