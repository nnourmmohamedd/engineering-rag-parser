...
from engineering_rag_parser import __version__
from engineering_rag_parser.cli import _force_utf8_streams, app
...
class TestEndToEndCliOnSyntheticPdf:
    ...
    def completed_run(cls, structured_pdf: Path, tmp_path_factory: pytest.TempPathFactory) -> Path:
        ...
        result = run_pipeline(structured_pdf, cfg, artifacts)
