...
from engineering_rag.services.parser.validation.markdown import json_checks, markdown_checks
from engineering_rag.services.parser.validation.source import (
    build_page_coverage,
    coverage_checks,
    document_completeness_check,
    strip_furniture,
)
from engineering_rag.services.parser.validation.structure import table_checks
...
class TestStripFurniture:
    def test_removes_matching_lines_and_counts_chars(self) -> None:
        from engineering_rag.services.parser.normalization import normalize_line
