...
`convert_pdf`, the single choke point `run_pipeline` calls into. This avoids a
...
from engineering_rag_parser.cli import app
...
class TestMissingOrFailingOcrBackend:
    def test_missing_ocr_dependency_fails_loudly_not_silently(
        ...
        monkeypatch.setattr("engineering_rag_parser.pipeline.convert_pdf", _boom)
