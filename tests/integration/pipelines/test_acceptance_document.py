...
from engineering_rag.services.parser.models import RunStatus, Severity
...
def acceptance_run(acceptance_pdf: Path, tmp_path_factory: pytest.TempPathFactory):
    ...
    return run_parsing_pipeline(acceptance_pdf, cfg, tmp_path_factory.mktemp("acceptance"))
